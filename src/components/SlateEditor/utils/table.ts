...
export class TableUtil {
  ...
  insertCells = (tableNode: any, path: string, action: string) => {
    let existingText = Array.from(tableNode.children, (rows: any) =>
      Array.from(rows.children, (arr: any) => arr.children[0].text),
    );
